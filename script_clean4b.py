...
with open('lib/views/admin/destination_management/modify_destination_screen.dart', 'r') as f:
    content = f.read()
...
with open('lib/views/admin/destination_management/modify_destination_screen.dart', 'w') as f:
    f.write(content)

print("Part 4b finished")
